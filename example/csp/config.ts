...
export function getConfig(): Config {
    ...
    assert(typeof config.cspApiVersion == "string", "config.yaml > cspApiVersion should be a string")
    ...
    assert(typeof config.privateKey == "string", "config.yaml > privateKey should be a string")
    assert(config.privateKey, "config.yaml > Please, set the privateKey to use")
