...
while(!fs.existsSync(path.join(packagePath, "package.json"))) {
    ...
    if(packagePath.length === 0 || !packagePathSplit.includes("snarkjs")) {
...
if (packageJson.hasOwnProperty('module') && packageJson.hasOwnProperty('name') && packageJson.name === "snarkjs") {
