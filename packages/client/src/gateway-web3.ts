...
import { BaseProvider, JsonRpcProvider, Web3Provider, IpcProvider, InfuraProvider, FallbackProvider, EtherscanProvider } from "@ethersproject/providers"
...
export class Web3Gateway implements IGatewayWeb3Client {
     ...
     */
    constructor(gatewayOrProvider: string | GatewayInfo | BaseProvider, networkId: EthNetworkID = "xdai", environment: VocdoniEnvironment = "prod") {
        ...
        else if (gatewayOrProvider instanceof BaseProvider) { // use as a provider
