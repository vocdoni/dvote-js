...
describe("Transaction signing", () => {
  describe("JSON payloads", () => {
    ...
    it("Should correctly verify signature of messages singed by go-dvote", () => {
      ...
      const signature = "8675144382150c3eb9da3b6c3c5591cbce07dd96f82400ca73cc4371718d87131bee51b8ad3a91cbad33b44f94654b145b5383f03e5137a663b14ecc1d94ec7000"
      const publicKey = "02f601098d41d6d91aabaedf245cf6ce2a0ba949c4013bc45b816615d40f885e3a"
      expect(BytesSignature.isValidTransaction(msgBytes, "chain-123", signature, publicKey)).to.be.true
    })
    it("Should create the same signature as go-dvote", async () => {
      const wallet = new Wallet("94f3a5c22e1dc88f9757b945da0e6d00d1c97772235c9ebd8197df8977c635a4")
      const message = { "method": "getVisibility", "timestamp": 1582196988222 }

      const signature = await JsonSignature.signTransaction(message, "chain-123", wallet)
      const expectedSignature = "0x8675144382150c3eb9da3b6c3c5591cbce07dd96f82400ca73cc4371718d87131bee51b8ad3a91cbad33b44f94654b145b5383f03e5137a663b14ecc1d94ec701b"
  ...
  describe("Bytes payloads", () => {
    ...
    it("Should correctly verify signature of messages singed by go-dvote", () => {
      ...
      const signature = "4e0c9166442322ba15d241782804c1c3f6f0b8a55bfa279949b597ee4c9717bd6149b677ab0fccc48823cdc88b24ad56abc89d5ea4e48aea2d4febd911b7345801"
      const publicKey = "03f0029f3a35380b528de4ea7194e36c1fa1505781fe7dd8ffe82525952f34ce8d"
      expect(BytesSignature.isValidTransaction(msgBytes, "chain-123", signature, publicKey)).to.be.true
    })
    it("Should create the same signature as go-dvote", async () => {
      const wallet = new Wallet("94f3a5c22e1dc88f9757b945da0e6d00d1c97772235c9ebd8197df8977c635a4")
      ...
      const signature = await BytesSignature.signTransaction(msgBytes, "chain-123", wallet)
      const expectedSignature = "0x8675144382150c3eb9da3b6c3c5591cbce07dd96f82400ca73cc4371718d87131bee51b8ad3a91cbad33b44f94654b145b5383f03e5137a663b14ecc1d94ec701b"
      expect(signature).to.equal(expectedSignature)
    })
  })
