...
import { ApiMethod, IGatewayClient, IGatewayDVoteClient, IGatewayWeb3Client, DVoteGateway, DVoteGatewayResponseBody, IRequestParameters, ResultsNotAvailableError } from "@vocdoni/client"
...
export namespace VotingApi {
    ...
    */
    ...
    export function getSignedVoteNullifier(address: string, processId: string): string {
        ...
        return keccak256(arrayify("0x" + address + processId))
    }
}
