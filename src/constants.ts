...
export const vocdoniHomesteadEntityId = "0x0"
...
export const VOCHAIN_BLOCK_TIME = 5 // seconds
export const CENSUS_MAXIMUM_BULK_CLAIMS = 400 // # of claims per addClaimBulk request
