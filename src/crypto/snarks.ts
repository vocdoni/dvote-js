...
async function getWitnessCalculator(code: Uint8Array) {
  ...
  function onException(code: number) {
    let errStr: string
    switch (code) {
      case 1:
        errStr = "Signal not found."; break
      case 2:
        errStr = "Too many signals set."; break
      case 3:
        errStr = "Signal already set."; break
      case 4:
        errStr = "Assert Failed."; break
      case 5:
        errStr = "Not enough memory."; break
      default:
